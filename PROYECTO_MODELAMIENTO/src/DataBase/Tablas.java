...
public void tbUsuarios(JTable tabla, String condision) {
    ArrayList<Usuario> usuarios;

    try {
        Consultar_db cons= new Consultar_db("Usuario", condision);
        usuarios=cons.consultarUsuarios();
        //Datos de Tabla
        ...
        while (i<tamaño) {
            modelo.addRow(new Object[]{usuarios.get(i).obtenerNombre(),
            usuarios.get(i).obtenerCorreo(),
            usuarios.get(i).obtenerId()});
            i++;
        }
